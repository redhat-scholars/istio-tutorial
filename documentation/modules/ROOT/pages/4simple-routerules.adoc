...
For this use case, we need to create a modified version of Recommendation
...
[source,bash,subs="+macros,+attributes"]
----
oc apply -f link:{github-repo}/{recommendation-repo}/kubernetes/Deployment-v2.remote.yml[{recommendation-repo}/kubernetes/Deployment-v2.remote.yml] 
----
...
[source,bash,subs="+macros,+attributes"]
----
oc get pods -w -n $WORKSHOP_USER-istiotutorial
...
Now, you will see two responses from the v2 and one for v1.
...
customer => preference => recommendation v2 from '99634814-p7jb2': 1
----
...
kubectl create -f link:{github-repo}/{istiofiles-dir}/virtual-service-recommendation-v2.yml[istiofiles/virtual-service-recommendation-v2.yml] 
...
[source,bash,subs="+macros,+attributes"]
----
kubectl replace -f link:{github-repo}/{istiofiles-dir}/virtual-service-recommendation-v1.yml[istiofiles/virtual-service-recommendation-v1.yml] 
...
[source,bash,subs="+macros,+attributes"]
----
kubectl replace -f link:{github-repo}/{istiofiles-dir}/virtual-service-recommendation-v1_and_v2_75_25.yml[istiofiles/virtual-service-recommendation-v1_and_v2_75_25.yml] 
----
