...
+
--
[#srr-scale-recommendation-v2]
[source,bash,subs="+macros,+attributes"]
----
kubectl -n tutorial{namespace-suffix} scale --replicas=2 deployment/recommendation-v2 
----
copyToClipboard::srr-scale-recommendation-v2[]
--
oc::
+
--
[#srr-oc-scale-recommendation-v2]
[source,bash,subs="+macros,+attributes"]
----
oc scale  -n tutorial{namespace-suffix} --replicas=2 deployment/recommendation-v2
----
copyToClipboard::srr-oc-scale-recommendation-v2[]
--
====
...
+
--
[#srr-scale-one-recommendation-v2]
[source,bash,subs="+macros,+attributes"]
----
kubectl -n tutorial{namespace-suffix} scale --replicas=1 deployment/recommendation-v2 
----
copyToClipboard::srr-scale-recommendation-v2[]
--
oc::
+
--
[#srr-oc-scale-one-recommendation-v2]
[source,bash,subs="+macros,+attributes"]
----
oc scale  -n tutorial{namespace-suffix} --replicas=1 deployment/recommendation-v2
----
copyToClipboard::srr-oc-scale-recommendation-v2[]
--
====
