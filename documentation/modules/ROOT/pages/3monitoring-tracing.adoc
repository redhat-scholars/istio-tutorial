...
image:../assets/images/grafana1.png[Grafana 1]
...
image:../assets/images/grafana2.png[Grafana 2]
...
image:../assets/images/prometheus_custom_metric.png[alt text]
...
or
firefox http://tracing-istio-system.{appdomain}/
endif::workshop[]
...
image:../assets/images/jaegerUI.png[Trace as seen in Jaeger]
