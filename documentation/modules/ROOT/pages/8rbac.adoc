...
----
kubectl create -f link:{github-repo}/{istiofiles-dir}/authorization-policy-jwt.yaml[istiofiles/authorization-policy-jwt.yaml] -n tutorial
----
...
[source, bash, subs="+macros,+attributes"]
----
kubectl replace -f link:{github-repo}/{istiofiles-dir}/authorization-policy-jwt.yaml[istiofiles/authorization-policy-jwt.yaml] -n tutorial
----
