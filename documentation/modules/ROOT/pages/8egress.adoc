...
The second change is to change the default output to make a call to http://worldclockapi.com/api/json/cet/now.
...
[source,bash,subs="+macros,+attributes"]
----
istioctl create -f link:{github-repo}/{istiofiles-dir}/service-entry-egress-worldclockapi.yml[istiofiles/service-entry-egress-worldclockapi.yml] -n tutorial

istioctl get serviceentry

curl customer-tutorial.$(minishift ip).nip.io
customer => preference => 2019-03-27T16:01+01:00 recommendation v3 from '7b445dd469-j6rkg': 1
----
...
[source,bash]
----
istioctl delete -f istiofiles/service-entry-egress-worldclockapi.yml -n tutorial
