...
The result is `disablePolicyChecks is false` if you installed Istio by using `istio-demo.yaml` file.
If not then refer to https://istio.io/docs/tasks/policy-enforcement/enabling-policy/
====
