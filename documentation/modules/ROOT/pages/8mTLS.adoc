...
----
kubectl create -f link:{github-repo}/{istiofiles-dir}/gateway-customer.yml[istiofiles/gateway-customer.yml]
----
...
[source, bash,subs="+macros,+attributes"]
----
kubectl create -f link:{github-repo}/{istiofiles-dir}/authentication-enable-tls.yml[istiofiles/authentication-enable-tls.yml] # <1>
kubectl create -f link:{github-repo}/{istiofiles-dir}/destination-rule-tls.yml[istiofiles/destination-rule-tls.yml] # <2>
----
...
By _sniffing_ traffic between services, which is a bit more tedious, open a new terminal tab and run next command:
...
[source, bash]
----
kubectl delete -f istiofiles/authentication-enable-tls.yml
...
source,bash]
----
kubectl delete -f istiofiles/gateway-customer.yml
----
