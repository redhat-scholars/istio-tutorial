...
istio:
	...
	tar -xvzf /root/installation/istio-1.0.5-linux.tar.gz -C /root/installation
	...
	oc apply -f /root/installation/istio-1.0.5/install/kubernetes/helm/istio/templates/crds.yaml
	oc apply -f /root/installation/istio-1.0.5/install/kubernetes/istio-demo.yaml
...
microservices:
	...
	/root/installation/istio-1.0.5/bin/istioctl kube-inject -f /root/projects/istio-tutorial/customer/kubernetes/Deployment.yml | oc apply -n tutorial -f -
	...
	/root/installation/istio-1.0.5/bin/istioctl kube-inject -f /root/projects/istio-tutorial/preference/kubernetes/Deployment.yml | oc apply -n tutorial -f -
	...
	/root/installation/istio-1.0.5/bin/istioctl kube-inject -f /root/projects/istio-tutorial/recommendation/kubernetes/Deployment.yml | oc apply -n tutorial -f -
