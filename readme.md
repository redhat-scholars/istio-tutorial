...
There are different ways to configure the tracer. The Customer Java service is using `tracerresolver`
which does not require any code changes and the whole configuration is defined in
[environmental variables](./customer/java/Dockerfile).
Whereas the Preference Java service is instantiating the tracer bean directly in
[Spring configuration class](./preference/java/src/main/java/com/redhat/developer/demos/preference/PreferencesApplication.java).
