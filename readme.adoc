...
grafana-cd99bf478-59ndr                     1/1       Running     4          4d
istio-citadel-ff5696f6f-grn7m               1/1       Running     4          4d
istio-cleanup-old-ca-x49kj                  0/1       Completed   0          4d
istio-egressgateway-58d98d898c-xb7n9        1/1       Running     5          4d
istio-ingressgateway-6bc7c7c4bc-lxwn8       1/1       Running     5          4d
istio-mixer-post-install-wwj4p              0/1       Completed   0          4d
istio-pilot-6c5c6b586c-gvwcr                2/2       Running     8          4d
istio-policy-5c7fbb4b9f-jgqcn               2/2       Running     8          4d
istio-sidecar-injector-dbd67c88d-rwj4v      1/1       Running     4          4d
istio-statsd-prom-bridge-6dbb7dcc7f-5tlsd   1/1       Running     4          4d
istio-telemetry-54b5bf4847-9w8m9            2/2       Running     8          4d
istio-tracing-67dbb5b89f-g2jh6              1/1       Running     5          4d
prometheus-586d95b8d9-4pnfm                 1/1       Running     8          4d
servicegraph-6d86dfc6cb-vq27n               1/1       Running     21         4d
----
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-v1.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-v1_and_v2_75_25.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/route-rule-safari-recommendation-v2.yml -n tutorial
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-safari-recommendation-v2.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-mobile-recommendation-v2.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-v1-mirror-v2.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/recommendation_cb_policy_version_v2.yml -n tutorial
...
[source,bash]
----
istioctl replace -f istiofiles/recommendation_cb_policy_pool_ejection.yml -n tutorial
----
...
IMPORTANT: `/routes` is not valid anymore, and I have not found any endpoint that can be the replacement.
