...
oc create -f http:...../install/istio.yaml
...
grafana-cd99bf478-42c6h                     1/1       Running     0          3m
istio-citadel-ff5696f6f-qm9tq               1/1       Running     0          3m
istio-cleanup-old-ca-dmsrv                  0/1       Completed   0          3m
istio-egressgateway-58d98d898c-dcvq5        1/1       Running     0          3m
istio-ingress-6fb78f687f-5kszr              1/1       Running     0          3m
istio-ingressgateway-6bc7c7c4bc-9mzkg       1/1       Running     0          3m
istio-mixer-post-install-g9cd5              0/1       Completed   0          3m
istio-pilot-6c5c6b586c-ghfjj                2/2       Running     0          3m
istio-policy-5c7fbb4b9f-lg2hq               2/2       Running     0          3m
istio-statsd-prom-bridge-6dbb7dcc7f-6qchs   1/1       Running     0          3m
istio-telemetry-54b5bf4847-4rtmf            2/2       Running     0          3m
jaeger-65dc9f8686-l6d9f                     1/1       Running     0          48s
prometheus-586d95b8d9-5jxpc                 1/1       Running     0          3m
servicegraph-6d86dfc6cb-b4js5               1/1       Running     0          3m
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-v2-new.yml -n tutorial
...
[source,bash]
----
istioctl replace -f istiofiles/route-rule-recommendation-v1-new.yml -n tutorial
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-v1-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-v1_and_v2-new.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/route-rule-recommendation-v1_and_v2_75_25-new.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-v1_and_v2_75_25-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-503-new.yml -n tutorial
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-503-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-delay-new.yml -n tutorial
----
...
[source]
----
istioctl delete -f istiofiles/route-rule-recommendation-delay-new.yml -n tutorial
----

== Retry [Istio 0.8.0 I have not been able to make it run]
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-timeout-new.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-timeout-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-v1-new.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/route-rule-safari-recommendation-v2-new.yml -n tutorial
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-safari-recommendation-v2-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-mobile-recommendation-v2-new.yml -n tutorial
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-mobile-recommendation-v2-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-v1-mirror-v2-new.yml -n tutorial
...
[source,bash]
----
istioctl delete -f istiofiles/route-rule-recommendation-v1-mirror-v2-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/recommendation_lb_policy_app-new.yml -n tutorial
----
...
[source,bash]
----
istioctl delete -f istiofiles/recommendation_lb_policy_app-new.yml -n tutorial
...
[source,bash]
----
istioctl create -f istiofiles/route-rule-recommendation-v1_and_v2_50_50-new.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/recommendation_cb_policy_version_v2-new.yml -n tutorial
...
istioctl delete -f istiofiles/recommendation_cb_policy_version_v2-new.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/recommendation_cb_policy_pool_ejection-new.yml -n tutorial
----
...
[source,bash]
----
istioctl replace -f istiofiles/route-rule-recommendation-v1_and_v2_retry-new.yml -n tutorial
----
...
[source,bash]
----
istioctl create -f istiofiles/egress_github-new.yml -n istioegress
